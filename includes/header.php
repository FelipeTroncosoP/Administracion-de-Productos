...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-light bg-light border"> 
        <a href="#" class="navbar-brand">Don Mateo Spa</a>
            ...
            <div class="row">
                ...
                <ul class="navbar-nav flex-column mt-4">
                    ...
                    <li class="nav-item"><a href="#" class="nav-link text-white p-1 mb-2 sidebar-link">
                        <i class="fas fa-cart-plus text-light fa-lg mr-3"></i>Ofertas del Mes</a></li>
                    <li class="nav-item"><a href="http://donmateo.cl/webmail" class="nav-link text-white p-1 mb-2 sidebar-link">
